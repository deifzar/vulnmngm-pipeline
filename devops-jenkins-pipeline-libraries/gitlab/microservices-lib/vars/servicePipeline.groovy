def call(Closure configClosure) {
  def config = [
    ...
    publishBinary           : true,
    composeStackRepo        : 'gitlab.com/cptm8microservices/cptm8-compose-stack.git',
  ...
  pipeline {
    ...
    environment {
      ...
      SONARQUBE-CLI = "sonarsource/sonar-scanner-cli:12.0"
    }
          ...
          script {
            ...
            withCredentials([usernamePassword(
              ...
              sh """
                ...
                rm -rf compose-stack
                git clone https://${GIT_USERNAME}:${GIT_TOKEN}@${config.composeStackRepo} compose-stack
                cd compose-stack
